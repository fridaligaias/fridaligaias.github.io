...
## 🛠️ What’s Inside
The portfolio features a range of projects that span several key disciplines:

* **Intelligent Systems:** Implementations in autonomous navigation and reinforcement learning.
* **Defensive AI:** Explorations into model security and adversarial testing.
* **Data-Driven Solutions:** Large-scale data analysis and survival prediction systems.
* **Full-Stack Web:** Responsive, high-performance web applications built with modern frameworks.

For a full breakdown of the technologies used and the specific outcomes of these projects, please visit the [Live Portfolio](https://fridaligaias.github.io/).
